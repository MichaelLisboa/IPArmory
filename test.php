...
<!DOCTYPE html>
    ...
    <head>
        ...
        <!-- Main Stylesheet -->
        <link rel="stylesheet" href="/css/main2.php?v=<?php echo rand() ?>">
		<!-- Media Queries -->
    ...
    <body id="body">
		...
		<div id="loading-mask">
			<div class="loading-img">
				<img alt="<?php echo $companyName ?> Preloader" src="img/preloader.gif"  />
			</div>
		</div>
        <!--
        End Preloader
			...
			<div class="container">
				<div class="row">
					...
					<div class="title text-center wow fadeIn" data-wow-duration="1500ms" >
						<h2>What is <span class="color"><?php echo $companyName ?>?</span></h2>
		...
		Start Epic Video
		==================================== -->
		<section id="main-features" style="background-color:#202125;">
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<div class="row">
					...
					<div class="title text-center wow fadeInDown">
						<h2><?php echo $companyName ?> Holds <span class="color">Exclusive Patents</span></h2>
						<div class="border"></div>
					</div>
					<!-- /section title -->
			...
			<div class="container">
				<div class="row">					<!-- section title -->
				    <div class="title text-center wow fadeInDown" data-wow-duration="500ms">
			        	<h2>The <?php echo $companyName ?><span class="color"> Investment Timeline</span></h2>
				        <div class="border"></div>
				    </div>
				    <!-- /section title -->
					...
					<article class="col-md-4 col-sm-6 col-xs-12 text-center wow fadeInUp" data-wow-duration="200ms">
						<div class="pricing">
							...
							<div class="price-title">
								...
								<p>Up to <strong class="value">$500,000</strong> USD</p>
							</div>
							<!-- /plan name & value -->							
							<!-- plan description -->
							<ul>
								<li>Funding via <a href="convertible-note-memo.php" class="color">Convertible Loans</a></li>
								<li>2 months to live website</li>
								<li>6 months to prototype app</li>
								<li>Initial staff recruitment</li>
					...
					<article class="col-md-4 col-sm-6 col-xs-12 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="400ms">
						<div class="pricing">						
							...
							<div class="price-title">
								...
								<p>Seeking <strong class="value">$1 Million</strong> USD</p>
							</div>
							<!-- /plan name & value -->
					...
					<div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-duration="500ms" data-wow-delay="200ms">
		               <article class="team-mate">
							<div class="member-photo">
								...
								<div class="mask">
									<ul class="clearfix">
										<li><a href="https://www.facebook.com/kittychopaka"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://www.linkedin.com/in/kitty-chopaka-ab731989"><i class="fa fa-linkedin"></i></a></li>
										<li><a href="https://www.instagram.com/kittychopaka/"><i class="fa fa-instagram"></i></a></li>
									</ul>
								</div>
								<!-- /member social profile -->
							</div>
